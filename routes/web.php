...
Route::delete('/images/{image}/{post}', [ImageController::class, 'delete']);

Route::post('comments/{post}', [CommentController::class, 'store']);
Route::delete('/comments/{comment}/{post}', [CommentController::class, 'delete']);
...
Route::delete('/works/{work}', [WorkController::class, 'delete']);
